...
use CompBundle\Entity\Paiement;
...
class PaiementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $paiements = $em->getRepository('CompBundle:Paiement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CompBundle\Form\PaiementType', $paiement);
    ...
    {
        $deleteForm = $this->createDeleteForm($paiement);
        $editForm = $this->createForm('CompBundle\Form\PaiementType', $paiement);
