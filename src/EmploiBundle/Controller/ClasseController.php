...
use EmploiBundle\Entity\Classe;
...
class ClasseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $classes = $em->getRepository('EmploiBundle:Classe')->findAll();
    ...
    {
        $classe = new Classe();
        $form = $this->createForm('EmploiBundle\Form\ClasseType', $classe);
    ...
    {
        $deleteForm = $this->createDeleteForm($classe);
        $editForm = $this->createForm('EmploiBundle\Form\ClasseType', $classe);
