...
class SalleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $salles = $em->getRepository('EmploiBundle:Salle')->findAll();
    ...
    {
        $salle = new Salle();
        $form = $this->createForm('EmploiBundle\Form\SalleType', $salle);
    ...
    {
        $deleteForm = $this->createDeleteForm($salle);
        $editForm = $this->createForm('EmploiBundle\Form\SalleType', $salle);
