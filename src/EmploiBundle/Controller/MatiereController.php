...
use EmploiBundle\Entity\Matiere;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $matieres = $em->getRepository('EmploiBundle:Matiere')->findAll();
    ...
    {
        $matiere = new Matiere();
        $form = $this->createForm('EmploiBundle\Form\MatiereType', $matiere);
    ...
    {
        $deleteForm = $this->createDeleteForm($matiere);
        $editForm = $this->createForm('EmploiBundle\Form\MatiereType', $matiere);
